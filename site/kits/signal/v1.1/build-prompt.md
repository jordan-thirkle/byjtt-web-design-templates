<!-- ByJTT prompt kit: signal v1.1 · build-prompt.md · kit version 1 · 2026-09-02.
...
1. Download the template package:
   `curl -L -o signal.zip https://byjtt-templates.pages.dev/assets/templates/signal/downloads/signal-v1.1.0.zip`
